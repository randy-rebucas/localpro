...
export function EmptyState({
	...
	return (
		<div className={cn("bg-white dark:bg-gray-800 rounded-xl p-10 text-center", className)}>
			...
			<h3 className="mt-6 text-lg font-semibold text-gray-700 dark:text-white">{title}</h3>
			{description && (
