...
export function GCashPayment({
  ...
  const handlePhoneSubmit = async () => {
    if (!phoneNumber || phoneNumber.length < 10) {
      showToast("Please enter a valid GCash-registered phone number", "error");
      return;
    }
  ...
  const handleConfirmPayment = async () => {
    ...
    setTimeout(() => {
      ...
      logger.info("GCash payment completed", { transactionId, amount, currency });
    ...
    return (
      <Card className="p-4 border-2 border-dashed border-gray-300 bg-gray-50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="font-medium text-gray-500">GCash</p>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Enter the phone number linked to your GCash account
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <p className="text-sm text-green-700">
              Check your GCash app and approve the payment for {formatCurrency(amount, currency)}
            </p>
          </div>
