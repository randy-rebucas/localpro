...
export default function ErrorMonitoringPage() {
  ...
  const fetchErrorData = async () => {
    try {
      ...
      logger.error('Error fetching error data', err instanceof Error ? err : new Error(String(err)));
  ...
  const resolveError = async (errorId: string) => {
    try {
      ...
      logger.error('Error resolving error', err instanceof Error ? err : new Error(String(err)), { errorId });
  ...
  const unresolveError = async (errorId: string) => {
    try {
      ...
      logger.error('Error unresolving error', err instanceof Error ? err : new Error(String(err)), { errorId });
