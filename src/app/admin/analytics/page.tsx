                          ...
                          {timeSeries.series.slice(-30).map((point, idx) => {
                            ...
                            return (
                              <div key={idx} className="flex-1 flex flex-col items-center group relative">
                                ...
                                <div className="w-full bg-blue-500 rounded-t transition-all hover:bg-blue-600" style={{ height: `${height}%`, minHeight: value > 0 ? '4px' : '0' }} />
                              </div>
                            );
                          })}
                        </div>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={() => setShowFilters(!showFilters)} className="text-xs text-blue-600 hover:text-blue-800">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button onClick={fetchCustomAnalytics} disabled={customLoading} className="px-3 py-1.5 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 disabled:opacity-50">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {filteredEvents.length === 0 ? (
                        ...
                        <tr key={event._id} className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2"><span className="px-2 py-0.5 text-xs bg-blue-100 text-blue-800 rounded">{formatEventType(event.eventType)}</span></td>
