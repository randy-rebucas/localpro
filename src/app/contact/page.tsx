        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link
                href="/help-center"
                className="bg-slate-50 dark:bg-slate-700 rounded-xl p-6 hover:shadow-lg transition-shadow group"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <ArrowRight className="w-5 h-5 text-slate-400 group-hover:text-blue-600 dark:group-hover:text-emerald-400 transition-colors" />
                </div>
              </Link>
              <Link
                href="/community"
