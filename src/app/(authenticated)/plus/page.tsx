...
export default function PlusPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50/30 relative overflow-hidden">
        <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-200/20 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-200/20 rounded-full blur-3xl animate-float animation-delay-2000"></div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50/30 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-200/20 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-200/20 rounded-full blur-3xl animate-float animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-yellow-100/20 rounded-full blur-3xl animate-float animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Unlock <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-500">LocalPro+</span>
          </h1>
          ...
          {/* Billing Toggle */}
          <div className="inline-flex items-center gap-4 bg-white rounded-full p-1.5 border-2 border-gray-200 shadow-lg">
            <button
        ...
        {/* Subheader Links */}
        <div className="mb-8 flex items-center justify-center gap-6 border-b border-gray-200 pb-4 flex-wrap">
          <Link 
            href="/referrals" 
            className="inline-flex items-center gap-2 text-gray-600 hover:text-yellow-600 transition-colors group"
          >
            <Gift className="w-4 h-4 text-yellow-500 group-hover:scale-110 transition-transform" />
