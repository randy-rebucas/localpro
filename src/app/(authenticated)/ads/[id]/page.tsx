                      ...
                      {images.map((image, index) => (
                        <button
                          ...
                          className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden ${
                            index === selectedImageIndex ? 'ring-2 ring-ring' : ''
                          }`}
                        >
                          <Image
                  ...
                  <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                          {ad.targetAudience.behavior.userTypes.map((type) => (
                            <span
                              key={type}
                              className="bg-accent/10 text-accent px-3 py-1 rounded-full text-sm capitalize"
                            >
                              {type}
                            </span>
                          ))}
                    ...
                    {ad.targetAudience.behavior?.activityLevel && (
                      <div>
                        ...
                        <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-sm capitalize">
                          {ad.targetAudience.behavior.activityLevel}
                        </span>
                      </div>
                    )}
