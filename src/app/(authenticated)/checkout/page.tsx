    ...
    return (
      <div className="min-h-screen bg-slate-950 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 py-16">
          <div className="bg-slate-900/80 rounded-2xl border border-slate-800 shadow-xl p-8 text-center">
            ...
            <p className="text-slate-400 mb-6">Thank you for your order. We&apos;ll send you a confirmation email shortly.</p>
            
            <div className="bg-emerald-500/10 rounded-xl p-4 mb-8 border border-emerald-500/20">
              <p className="text-sm text-slate-400">Order ID</p>
              <p className="text-xl font-bold text-emerald-400">{orderId}</p>
            </div>
            
            <div className="space-y-3 mb-8 text-left bg-slate-800 rounded-xl p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/supplies"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-slate-700 text-slate-300 rounded-lg font-medium hover:border-emerald-500 hover:bg-slate-800 transition-all"
              >
                View Orders
              </Link>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.firstName ? 'border-red-500' : 'border-slate-700'}`}
                      placeholder="Juan"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.lastName ? 'border-red-500' : 'border-slate-700'}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.email ? 'border-red-500' : 'border-slate-700'}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.phone ? 'border-red-500' : 'border-slate-700'}`}
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.address ? 'border-red-500' : 'border-slate-700'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.city ? 'border-red-500' : 'border-slate-700'}`}
                    placeholder="Manila"
                  />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.state ? 'border-red-500' : 'border-slate-700'}`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-lg bg-slate-800 text-white placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all ${errors.zipCode ? 'border-red-500' : 'border-slate-700'}`}
                      placeholder="1000"
                    />
              ...
              <div className="space-y-3">
                <label
                  className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === "cod" ? "border-emerald-500 bg-emerald-500/10" : "border-slate-700 hover:border-emerald-500/50"
                  }`}
                >
                  <input
                    type="radio"
                ...
                <label
                  className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === "gcash" ? "border-emerald-500 bg-emerald-500/10" : "border-slate-700 hover:border-emerald-500/50"
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-400">Pay via GCash mobile wallet</p>
                  </div>
                ...
                <label
                  className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    paymentMethod === "card" ? "border-emerald-500 bg-emerald-500/10" : "border-slate-700 hover:border-emerald-500/50"
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-400">Visa, Mastercard, and more</p>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900/80 rounded-xl border border-slate-800 shadow-lg p-6 sticky top-24">
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm font-semibold text-emerald-400">{formatPrice(item.price * item.quantity)}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="border-t-2 border-slate-800 pt-4 space-y-3">
                ...
                {subtotal < 5000 && (
                  <p className="text-xs text-slate-500">Add {formatPrice(5000 - subtotal)} more for free shipping!</p>
                )}
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">VAT (12%)</span>
              ...
              <div className="border-t-2 border-slate-800 mt-4 pt-4">
                ...
                <button
                  ...
                  disabled={processing}
                  className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl font-bold text-lg shadow-lg shadow-emerald-500/30 hover:from-emerald-600 hover:to-emerald-700 hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {processing ? (
                    <>
