...
export default function MarketplaceRentalsPage() {
    ...
    const fetchRentals = useCallback(async () => {
        try {
            ...
            logger.debug("Fetching rentals with params", { params: params.toString() });
            ...
            try {
                ...
                logger.debug("Primary API failed, trying fallback API", { fetchError: fetchError instanceof Error ? fetchError : new Error(String(fetchError)), hasCoordinates });
            ...
            logger.debug(`Fetched from ${hasCoordinates ? 'nearby' : 'regular'} endpoint`, { hasCoordinates, endpoint: hasCoordinates ? 'nearby' : 'regular' });
            ...
            logger.error("Error fetching rentals", error instanceof Error ? error : new Error(String(error)), { filters, sortBy, pagination: paginationRef.current });
