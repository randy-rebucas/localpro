...
export default function MarketplaceSuppliesPage() {
    ...
    const fetchSupplies = useCallback(async () => {
        try {
            ...
            logger.debug("Fetching supplies", { params: params.toString(), hasCoordinates });
            ...
            logger.debug("Fetched supplies", { endpoint: hasCoordinates ? 'nearby' : 'regular', hasData: !!data });

            logger.debug("Supplies data", { hasData: !!data, isArray: Array.isArray(data) });
            ...
            if (Array.isArray(data)) {
                ...
                if ('success' in data && data.success && 'data' in data && data.data) {
                    logger.debug("Supplies API response", { 
                    ...
                    if (normalizedProducts.length > 0) {
                        logger.debug("First product structure", { 
                            hasProduct: !!normalizedProducts[0],
                            hasSupplier: !!normalizedProducts[0].supplier,
                            hasPricing: !!normalizedProducts[0].pricing
                        });
                    }
