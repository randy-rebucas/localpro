  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
                ...
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <span className={`text-xs mt-2 text-center max-w-[80px] ${
                      isActive ? 'text-emerald-400 font-semibold' : isCompleted ? 'text-emerald-400' : 'text-slate-500'
                    }`}>
                      {step.title}
                    </span>
                  </div>
        ...
        <div className="bg-slate-900/80 rounded-xl border border-slate-800 shadow-lg p-6 md:p-8 backdrop-blur-sm">
