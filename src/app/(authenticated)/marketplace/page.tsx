  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl animate-float"></div>
        ...
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-emerald-600/5 rounded-full blur-3xl animate-float animation-delay-4000"></div>
      </div>
