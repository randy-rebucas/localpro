...
export default function BookingDetailPage() {
  ...
  const handleBack = useCallback(() => {
    router.push('/marketplace/my-bookings');
  }, [router]);
          ...
          <div className="mb-8">
            <div className="mb-4">
              <button
                ...
                aria-label="Go back to my bookings"
              >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">View booking information</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">{booking.service?.name || booking.service?.title || 'Service Booking'}</h1>
