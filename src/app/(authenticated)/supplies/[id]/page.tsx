...
const getStatusConfig = (status: Supply['status']) => {
  switch (status) {
    ...
    case 'pre-order': return { bg: 'bg-primary/10', text: 'text-primary', label: 'Pre-Order' };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className="px-3 py-1.5 bg-primary/10 text-primary rounded-full font-medium text-sm">
                {supply.category}
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 shadow-lg p-6">
              ...
              {isOwnSupply && (
                <div className="flex items-center gap-2 mt-4 p-3 bg-primary/5 border border-primary/20 rounded-lg text-primary">
