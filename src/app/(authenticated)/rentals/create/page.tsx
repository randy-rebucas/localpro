      ...
      <div className="relative z-10 max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-gray-900 mb-1">Create New Rental</h1>
            <p className="text-sm text-gray-600">List your equipment, vehicle, or space for rent</p>
          </div>
