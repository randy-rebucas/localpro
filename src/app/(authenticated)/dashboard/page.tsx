    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="bg-slate-900/80 border border-slate-800 rounded-lg shadow-lg p-4 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2">
          <div className="h-5 bg-slate-800 rounded w-20 mb-4 animate-pulse"></div>
        ...
        <div>
          <div className="h-5 bg-slate-800 rounded w-24 mb-4 animate-pulse"></div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-lg shadow-lg p-4 animate-pulse">
