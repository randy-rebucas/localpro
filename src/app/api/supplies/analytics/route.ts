...
// GET /api/supplies/analytics - Get supplies analytics and statistics
export async function GET(request: NextRequest) {
  try {
    ...
    // Parse date range and other parameters
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: errorData.error || "Failed to fetch supplies analytics" },
    ...
    console.error("Error fetching supplies analytics:", error);
