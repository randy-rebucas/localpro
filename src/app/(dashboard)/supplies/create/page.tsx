  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Error creating supply:', errorData);
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Create New Supply</h1>
            <p className="text-gray-600">List your supplies and materials for sale</p>
          </div>
        </div>
